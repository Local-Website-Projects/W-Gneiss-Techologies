...
<div class="page-wrapper">
    ...
    <section class="main-slider-one">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="main-slider-one__content">
                                    <h5 class="main-slider-one__sub-title">Wellcome To It-Solution !</h5>
                                    <!-- slider-sub-title -->
                                    <h2 class="main-slider-one__title">Get Our Business<br> This It Soluti<span>o</span>n
                                    </h2><!-- slider-title -->
                                    <div class="main-slider-one__text">
                                        <p class="main-slider-one__text__one">Business a soluion and emirate in the Arab
                                            known <br>for luxury city for Company.</p>
                                    </div><!-- slider-text -->
        ...
        <div class="main-slider-one__project wow fadeInUp" data-wow-delay="200ms">
            ...
            <h5 class="main-slider-one__project__number count-box"><span class="count-text" data-stop="1283"
                                                                         data-speed="1500"></span>k+</h5>
			...
			"responsive": {
                ...
                <div class="item">
                    <div class="feature-one__item text-center wow fadeInUp" data-wow-delay="100ms">
                        ...
                        <p class="feature-one__item__text">We the other hand denounce with Solution business</p>
                ...
                <div class="col-xl-6 wow fadeInLeft" data-wow-delay="300ms">
                    <div class="about-one__content">
                        <div class="sec-title text-left">
                            ...
                            <h3 class="sec-title__title">We Can Clients with the<br> About Services</h3>
                            <!-- /.sec-title__title -->
                        </div><!-- /.sec-title -->
                ...
                <div class="col-lg-5 wow fadeInUp" data-wow-delay="100ms">
                    <div class="cta-one__content">
                        <div class="cta-one__box">
                            ...
                            <p class="cta-one__box__text">Every team has a culture and set of ct ations that have either
                                been aed orsve naturally evolved.</p>
                        </div>
                        <div class="cta-one__author">
                            ...
                            <a class="cta-one__author__rm" href="Contact">More <span
                                        class="fas fa-arrow-right"></span></a>
                        </div>
                        <p class="cta-one__content__text">29,0000 customers with our services <a href="Contact">(
                                Let’s Started )</a></p>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-6">
                    <div class="our-solution__content">
                        ...
                        <p class="our-solution__content__text">
                            Business tailored it design, management & support services business agency elit, sed do
                            eiusmod tempor.
                        </p>
                        <div class="row">
            ...
            <div class="row gutter-y-30">
                <div class="col-lg-4 col-md-6">
                    <div class="feature-two__item text-center wow fadeInUp" data-wow-delay="100ms">
                        ...
                        <p class="feature-two__item__text">We businesss standard chunk of Ipsum used since is Agency &
                            Star tup.</p>
                    </div><!-- feature-item -->
                </div>
                <div class="col-lg-4 col-md-6">
