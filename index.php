					...
					"margin": 30
                        ...
                        <div class="item">
                            <div class="product__item wow fadeInUp" data-wow-duration='1500ms' data-wow-delay='000ms'>
                                ...
                                <div class="product__item__content">
                                    ...
                                    <h4 class="product__item__title"><a href="product-details.html">Boss Sofa</a></h4>
                                    <!-- /.product-title -->
                                    <div class="product__item__price">$82.00</div><!-- /.product-price -->
                                    <a href="cart.html" class="tolak-btn product__item__link"><b>Add to
                                            Cart</b><span></span></a>
                                </div><!-- /.product-content -->
                            </div><!-- /.product-item -->
                        </div><!-- /.item -->
                        <div class="item">
                            <div class="product__item wow fadeInUp" data-wow-duration='1500ms' data-wow-delay='100ms'>
                                <div class="product__item__img">
                                    <img src="assets/images/products/product-1-2.jpg" alt="tolak">
                                    <div class="product__item__btn">
                                        <a href="cart.html"><i class="far fa-heart"></i></a>
                                        <a href="product-details.html"><i class="fas fa-eye"></i></a>
                                    </div>
                                ...
                                <div class="product__item__content">
                                    ...
                                    <h4 class="product__item__title"><a href="product-details.html">Office Chair</a>
                                    </h4><!-- /.product-title -->
                        ...
                        <div class="item">
                            <div class="product__item wow fadeInUp" data-wow-duration='1500ms' data-wow-delay='200ms'>
                                <div class="product__item__img">
                                    <img src="assets/images/products/product-1-3.jpg" alt="tolak">
                                    <div class="product__item__btn">
                                        <a href="cart.html"><i class="far fa-heart"></i></a>
                                        <a href="product-details.html"><i class="fas fa-eye"></i></a>
                                    </div>
                                ...
                                <div class="product__item__content">
                                    ...
                                    <h4 class="product__item__title"><a href="product-details.html">Long Stool</a></h4>
                                    <!-- /.product-title -->
                        ...
                        <div class="item">
                            <div class="product__item wow fadeInUp" data-wow-duration='1500ms' data-wow-delay='300ms'>
                                <div class="product__item__img">
                                    <img src="assets/images/products/product-1-4.jpg" alt="tolak">
                                    <div class="product__item__btn">
                                        <a href="cart.html"><i class="far fa-heart"></i></a>
                                        <a href="product-details.html"><i class="fas fa-eye"></i></a>
                                    </div>
                                ...
                                <div class="product__item__content">
                                    ...
                                    <h4 class="product__item__title"><a href="product-details.html">Round Chair</a></h4>
                                    <!-- /.product-title -->
                        ...
                        <div class="item">
                            <div class="product__item wow fadeInUp" data-wow-duration='1500ms' data-wow-delay='400ms'>
                                <div class="product__item__img">
                                    <img src="assets/images/products/product-1-5.jpg" alt="tolak">
                                    <div class="product__item__btn">
                                        <a href="cart.html"><i class="far fa-heart"></i></a>
                                        <a href="product-details.html"><i class="fas fa-eye"></i></a>
                                    </div>
                                ...
                                <div class="product__item__content">
                                    ...
                                    <h4 class="product__item__title"><a href="product-details.html">Sofa Chair</a></h4>
                                    <!-- /.product-title -->
                        ...
                        <div class="item">
                            <div class="product__item wow fadeInUp" data-wow-duration='1500ms' data-wow-delay='500ms'>
                                <div class="product__item__img">
                                    <img src="assets/images/products/product-1-6.jpg" alt="tolak">
                                    <div class="product__item__btn">
                                        <a href="cart.html"><i class="far fa-heart"></i></a>
                                        <a href="product-details.html"><i class="fas fa-eye"></i></a>
                                    </div>
                                ...
                                <div class="product__item__content">
                                    ...
                                    <h4 class="product__item__title"><a href="product-details.html">White Chair</a></h4>
                                    <!-- /.product-title -->
                        ...
                        <div class="item">
                            <div class="product__item wow fadeInUp" data-wow-duration='1500ms' data-wow-delay='600ms'>
                                <div class="product__item__img">
                                    <img src="assets/images/products/product-1-7.jpg" alt="tolak">
                                    <div class="product__item__btn">
                                        <a href="cart.html"><i class="far fa-heart"></i></a>
                                        <a href="product-details.html"><i class="fas fa-eye"></i></a>
                                    </div>
                                ...
                                <div class="product__item__content">
                                    ...
                                    <h4 class="product__item__title"><a href="product-details.html">Wood Stool</a></h4>
                                    <!-- /.product-title -->
                        ...
                        <div class="item">
                            <div class="product__item wow fadeInUp" data-wow-duration='1500ms' data-wow-delay='700ms'>
                                <div class="product__item__img">
                                    <img src="assets/images/products/product-1-8.jpg" alt="tolak">
                                    <div class="product__item__btn">
                                        <a href="cart.html"><i class="far fa-heart"></i></a>
                                        <a href="product-details.html"><i class="fas fa-eye"></i></a>
                                    </div>
                                ...
                                <div class="product__item__content">
                                    ...
                                    <h4 class="product__item__title"><a href="product-details.html">Sofa Seat</a></h4>
                                    <!-- /.product-title -->
                        ...
                        <div class="item">
                            <div class="product__item wow fadeInUp" data-wow-duration='1500ms' data-wow-delay='800ms'>
                                <div class="product__item__img">
                                    <img src="assets/images/products/product-1-9.jpg" alt="tolak">
                                    <div class="product__item__btn">
                                        <a href="cart.html"><i class="far fa-heart"></i></a>
                                        <a href="product-details.html"><i class="fas fa-eye"></i></a>
                                    </div>
                                ...
                                <div class="product__item__content">
                                    ...
                                    <h4 class="product__item__title"><a href="product-details.html">Long Chair</a></h4>
                                    <!-- /.product-title -->
                ...
                <div class="item">
                    <div class="project-one__item">
                        <div class="project-one__item__image">
                            ...
                            <a href="Project-Details" class="project-one__item__image__rm"><span
                        ...
                        <div class="project-one__item__content">
                            ...
                            <h3 class="project-one__item__title"><a href="Project-Details">Business Of Growth</a>
                            </h3>
