...
if(isset($_POST['order_now'])){
    ...
    $insert_order = $db_handle->insertQuery("INSERT INTO `order_data`(`name`, `contact_no`, `email`, `address`, `product_code`, `inserted_at`) VALUES ('$full_name','$contact_number','$email','$address','$product_code','$inserted_at')");
    if($insert_order){
        echo "
        <script>
        alert ('Your request is accepted. We will contact you soon!');
...
<head>
    ...
    <title>Order Now || Gneiss Technologies</title>
    <!-- favicons Icons -->
            ...
            <div class="row">
                <div class="col-md-7">
                    <div class="page-header__content">
                        <h2 class="page-header__title">Order Now</h2>
            ...
            <div class="row d-flex align-items-center justify-content-center">
                <div class="col-lg-8 wow fadeInUp animated" data-wow-delay="300ms">
                    <div class="login-page__wrap">
                        <h3 class="login-page__wrap__title">Order Now</h3>
                        <form class="login-page__form" method="post" action="#">
                            ...
                            <div class="login-page__form-input-box">
                                <input type="text" placeholder="Product Code" name="product_code" value="<?php echo $_GET['product'];?>" required>
                            </div>
                            <div class="login-page__form-btn-box">
                                <button type="submit" class="tolak-btn tolak-btn--base" name="order_now">
