...
if(isset($_GET['id'])){
    $fetch_blog_details = $db_handle->runQuery("select * from previous_works where id = {$_GET['id']}");
}
else{
    echo "
    <script>
...
<head>
    ...
    <title>Project Details - Gneiss technology</title>
                ...
                <div class="col-lg-8">
                    <div class="blog-details__content">
                        ...
                        <p class="blog-details__text">
                            <?php echo $fetch_blog_details[0]['long_desc'];?>
